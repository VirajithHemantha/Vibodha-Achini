...
export default function AdminPage({ day }: AdminPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#fdfaf5] font-montserrat p-6 md:p-12">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-[#d4af37]/30">
        <div className="bg-[#045e54] p-6 text-center">
          <h1 className="font-cinzel text-2xl text-white">
            Link Generator - Day {day}
          </h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full border border-slate-200 rounded-lg p-3 text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#045e54]/50"
              >
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-white border border-[#045e54] text-[#045e54] rounded-lg font-bold uppercase tracking-widest text-xs hover:bg-slate-50 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-[#045e54] text-white rounded-lg font-bold uppercase tracking-widest text-xs hover:bg-[#034d44] transition-colors shadow-md"
                  >
